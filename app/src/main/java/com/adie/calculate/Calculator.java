...
import com.adie.calculate.CalculatorEditText.OnTextSizeChangeListener;
import com.adie.calculate.CalculatorExpressionEvaluator.EvaluateCallback;
...
public abstract class Calculator extends Activity
    ...
    protected CalculatorEditText mFormula2EditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFormula2EditText = (CalculatorEditText) findViewById(R.id.formula2);
        ...
        mFormulaEditText.setRawInputType(InputType.TYPE_CLASS_NUMBER);
        mFormulaEditText.setTextIsSelectable(true);

        mFormula2EditText.setRawInputType(InputType.TYPE_CLASS_NUMBER);
        mFormula2EditText.setTextIsSelectable(true);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mFormulaEditText.getText().toString().trim().isEmpty()){
                    mFormulaEditText.setError("Field ini harus di isi");
                    mFormulaEditText.requestFocus();
                }else if(mFormula2EditText.getText().toString().trim().isEmpty()){
                    mFormula2EditText.setError("Field ini harus di isi");
                    mFormula2EditText.requestFocus();
                }else {
                 int in  = Integer.valueOf(mFormulaEditText.getText().toString());
                 int out = Integer.valueOf(mFormula2EditText.getText().toString());
                 int bal = in-out;
                 txtresult.setText("Balance : "+bal);
                 setState(CalculatorState.RESULT);
                 //Toast.makeText(getApplicationContext(),"bakekok",Toast.LENGTH_LONG).show();
                }
    ...
    protected void setState(CalculatorState state) {
        if (mCurrentState != state) {
            ...
            if (state == CalculatorState.ERROR) {
                ...
                mFormula2EditText.setTextColor(
                        getResources().getColor(R.color.display_formula_text_color));
    ...
    public void onButtonClick(View view) {
        switch (view.getId()) {
            ...
            default:
                if(mFormulaEditText.isFocused()){
                    mFormulaEditText.append(((Button) view).getText());
                }else if(mFormula2EditText.isFocused()){
                    mFormula2EditText.append(((Button) view).getText());
                }
    ...
    private void onDelete() {
        ...
        if(mFormulaEditText.isFocused()){
            ...
            final Editable formulaText = mFormula2EditText.getEditableText();
            final int formulaLength = formulaText.length();
            if (formulaLength > 0) {
                formulaText.delete(formulaLength - 1, formulaLength);
            }
    ...
    private void onClear() {
        ...
        reveal(sourceView, R.color.calculator_accent_color, new AnimatorListenerWrapper() {
            ...
            public void onAnimationStart() {
                ...
                mFormula2EditText.getEditableText().clear();
                txtresult.setText("");
                mFormulaEditText.requestFocus();
            }
        });
